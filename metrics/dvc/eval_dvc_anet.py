...
if __name__ == '__main__':
    data_path = "/cfs/cfs-lugcocyb/yongxinguo/projects/project_temporal_video_understanding/dvc_videollama_slot_fm96_fmt_e9_fmt_ft_second_lora/fmt_activitynet_test_f96_result.json"
