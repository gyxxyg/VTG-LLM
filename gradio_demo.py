...
def parse_args():
    ...
    parser.add_argument("--cfg-path", default='yourpath/VTG-LLM/eval_configs/videollama-slot-96.yaml', help="path to configuration file.")
...
def upload_imgorvideo(gr_video, gr_img, text_input, chat_state,chatbot):
    ...
    img_list = []
    llm_message = chat.upload_video_without_audio(gr_video, chat_state, img_list, n_frms=8)
