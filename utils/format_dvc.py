...
def extract_time_from_para_special_time_token(paragraph):
    ...
    return extract_time_from_para(paragraph)
...
def format_dvc_output(caption):
    ...
    paras = caption
    timestamps, sents =  extract_time_from_para_special_time_token(paras)
